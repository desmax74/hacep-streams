...
public class CommandHandlerTest {
    ...
    public void visitFireAllRulesCommand() {
        ...
        logger.info("FireAllRulesCommand:{}",
                    command.toString());
    }
    ...
    public void visitFireUntilHaltCommand() {
        ...
        logger.info("FireUntilHaltCommand:{}",
                    command.toString());
    }
    ...
    public void visitEventInsertCommand() {
        ...
        logger.info("EventInsertCommand:{}",
                    command.toString());
    }
    ...
    public void visitListObjectsCommand() {
        ...
        logger.info("ListObjectsCommand:{}",
                    command.toString());
    }
    ...
    public void visitListObjectsCommandClassType() {
        ...
        executeAndVerifyResponseMessage(command,
                                        ...
                                        ListKieSessionObjectMessage.class,
                                        result -> myObject.equals(((List) result).get(0)));
        logger.info("ListObjectsCommandClassType:{} ListKieSessionObjectMessage:{}",
                    command.toString());
    }
    ...
    public void visitGetObjectCommand() {
        ...
        executeAndVerifyResponseMessage(command,
                                        ...
                                        myObject::equals);
        logger.info("GetObjectCommand:{} GetObjectMessage:{}",
                    command.toString(),
                    GetObjectMessage.class.toString());
    }
    ...
    public void visitListObjectsCommandNamedQuery() {
        ...
        logger.info("ListObjectsCommandNamedQuery:{}",
                    command.toString());
    }
    ...
    public void visitSnapshotOnDemandCommand() {
        ...
        logger.info("SnapshotOnDemandCommand:{}",
                    command.toString());
    }

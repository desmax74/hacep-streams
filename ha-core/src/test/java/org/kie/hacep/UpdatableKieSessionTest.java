...
public class UpdatableKieSessionTest {
    ...
    public void init() throws Exception {
        ...
        createAndDeployKJar(GAVUtils.getReleaseID(gav,
                                                  KieServices.get()),
                            Collections.singletonMap("src/main/resources/org/pkg1/r0.drl",
                                                     drl1));
        createAndDeployKJar(GAVUtils.getReleaseID(updatedGav,
                                                  KieServices.get()),
                            Collections.singletonMap("src/main/resources/org/pkg1/r0.drl",
                                                     drl2));
    ...
    public MavenRepository getRepository(KieServices srv) {
        ReleaseId initReleaseId = GAVUtils.getReleaseID("org.kie.server.initial:init-maven-repo:42",
                                                        srv);

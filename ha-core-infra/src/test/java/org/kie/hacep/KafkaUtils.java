...
public class KafkaUtils implements AutoCloseable {
    ...
    public void insertBatchStockTicketEvent(int items,
                                            ...
                                            Class sessionType,
                                            Listener listener) {
        insertBatchStockTicketEvent(items,
                                    topicsConfig,
                                    sessionType,
                                    Config.getProducerConfig("InsertBatchStockTicketEvent"),
                                    listener);
    }
    ...
    public void insertBatchStockTicketEvent(int items,
        ...
        if (sessionType.equals(RemoteStreamingKieSession.class)) {
            RemoteStreamingKieSessionImpl producer = new RemoteStreamingKieSessionImpl(props,
                                                                                       topicsConfig,
                                                                                       listener,
                                                                                       InfraFactory.getProducer(false));
            producer.fireUntilHalt();
